...
// Попытка сходу переписать общение через спец. выделенные оконца =)
//сначала сделаю окно для диалога (с кнопками)
//Потом делаю окно для введения букв!
function init() {
  makeDialog();
}
window.onload = init;
...
//Это вот все лучше зафигачить в функцию?!?
function makeGame() {
